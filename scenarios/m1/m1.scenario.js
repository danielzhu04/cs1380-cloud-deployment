...
/* Come up with an object that uses all valid (serializable)
  ...
  let object = {a: [1, 2, 3], b: {name: "John", age: 25, alive: true, birthday: new Date("1/1/01")}, c: new Error("This is an error"), d: null, e: new Date(11, 1), f: undefined, g: false, h: "testing", i: 11, j: (divisor, dividend) => `The quotient is ${dividend / divisor}`};
